...
Download `ToolBraid-0.3.1-windows-x64.zip` and `SHA256SUMS.txt` from the same [official release](https://github.com/Maharajahu/ToolBraid-Companion/releases). Use the release's Assets section, not GitHub's Source code archive.
